var User = {
  template: `
    ...
    <div class="col-6">
        ...
        <form @submit.prevent="checkForm" name="checkForm">
            <div class="mb-3">
                ...
                <input name="name" v-model="user.name" type="text" class="form-control" id="name" />

            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input name="email" v-model="user.email" type="text" class="form-control" id="email" />

            </div>
            <div class="mb-3">
                <label for="role" class="form-label">Select user role</label>

                <select class="form-select" aria-label="user-role" id="role" v-model="user.role" name="role">
    ...
    <div class="row mt-5">
        ...
        <div class="col-6">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-administrator-tab" data-bs-toggle="tab"
                        data-bs-target="#nav-administrator" type="button" role="tab" aria-controls="nav-administrator"
                        aria-selected="false">
                        Administrators
                    </button>

                    <button class="nav-link" id="nav-moderator-tab" data-bs-toggle="tab" data-bs-target="#nav-moderator"
                        type="button" role="tab" aria-controls="nav-moderator" aria-selected="false">
                        Moderators
                    </button>

                    <button class="nav-link" id="nav-subscriber-tab" data-bs-toggle="tab"
                        data-bs-target="#nav-subscriber" type="button" role="tab" aria-controls="nav-subscriber"
                        aria-selected="false">
                        Subscribers
                    </button>
                </div>
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade" id="nav-administrator" role="tabpanel"
        ...
        <div class="col-3">
            <button type="button" class="btn btn-primary" @click="populateWithDummyData">Fill with dummy data</button>
        </div>
    </div>
  </div>
    `,
